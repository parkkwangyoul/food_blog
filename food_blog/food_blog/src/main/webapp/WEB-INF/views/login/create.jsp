	...
	<form:form commandName="userInfo">
		<table class="fb-create-user-table">
			<tfoot>
				<tr>
					<td colspan="2">
						<input class="fb-create-submit fb-btn-orange" id="createFormSubmitBtn" type="submit" value="가입하기">
					</td>
				</tr>
			</tfoot>
			<tbody>
				<tr>
					...
					<td>
						<div class="fb-create-user-vaild-wrap" >
							<span class="fb-form-invalid">아이디는 1자&nbsp;이상&nbsp;20자&nbsp;이하를&nbsp;입력해야&nbsp;합니다.</span>
						</div>
						<form:input path="userId" class="fb-create-user-input" data-form="create"/>
				...
				<tr>
					...
					<td>
						...
						<form:input path="name" class="fb-create-user-input" data-form="createNm"/>
						<div class="fb-create-user-error">
				...
				<tr>
					...
					<td>
						...
						<form:password path="password" class="fb-create-user-input" data-form="createPw" />
						<div class="fb-create-user-error">
				...
				<tr>
					...
					<td>
						...
						<form:password path="confirmPassword" class="fb-create-user-input" />
						<div class="fb-create-user-error">
				...
				<tr>
					...
					<td>
						...
						<form:input path="emailAddress" class="fb-create-user-input" data-type="email" />
						<div class="fb-create-user-error">
				...
				<tr>
					...
					<td>
						<div class="fb-create-user-vaild-wrap" id="confirmBlog">
							<span class="fb-form-invalid">사용할 블로그 주소를 입력해 주세요.(20자 이내, 영어,숫자만 가능)</span>
						</div>
						<form:input path="blogAddress" class="fb-create-user-input" />
						<div class="fb-create-user-error">
